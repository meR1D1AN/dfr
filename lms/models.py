...
class Course(models.Model):
    ...
    photo = models.ImageField(upload_to="lms/course_photos", verbose_name="Фото", help_text="Загрузите фото курса",
                              **NULLABLE)
...
class Lesson(models.Model):
    ...
    photo = models.ImageField(upload_to="lms/lesson_photos", verbose_name="Фото", help_text="Загрузите фото",
                              **NULLABLE)
